  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-neutral-950 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-neutral-200 bg-white hover:bg-neutral-100 hover:text-neutral-800 dark:border-sky-800 dark:bg-sky-950 dark:hover:bg-sky-800 dark:hover:text-white",
        secondary:
          "bg-sky-100 text-neutral-800 hover:bg-sky-100/80 dark:bg-sky-800 dark:text-white dark:hover:bg-sky-800/80",
        ghost:
          "hover:bg-sky-50 hover:text-neutral-800 dark:hover:bg-sky-800 dark:hover:text-white",
