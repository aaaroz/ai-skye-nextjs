...
export const dummyFeatures: TFeature[] = [
  ...
  },
  {
    ...
    headline:
      "Jadilah bintang TikTok dengan konten kreatif berbasis AI dari KontenKilat.",
    slug: "konten-tiktok-post",
    prompts: [],
    category: "tiktok",
  },
  {
    ...
    headline:
      "Tingkatkan interaksi di Livestream TikTok Anda dengan ide kreatif berbasis AI.",
    slug: "konten-tiktok-livestream",
    prompts: [],
    category: "tiktok",
  },
  {
    ...
    headline:
      "Buat deskripsi produk TikTok yang menarik dan efektif dengan bantuan AI.",
    slug: "deskripsi-produk-tiktok",
    prompts: [],
    category: "tiktok",
  },
  {
    ...
    headline:
      "Ciptakan feed Instagram yang memikat dengan ide konten kreatif berbasis AI.",
    slug: "konten-instagram-post",
    prompts: [],
    category: "instagram",
  },
  {
    ...
    headline:
      "Tingkatkan engagement Instagram Story Anda dengan ide konten AI yang kreatif.",
  ...
  },
  {
    ...
    headline:
      "Buat deskripsi Instagram yang menarik dan informatif dengan bantuan AI.",
    slug: "deskripsi-instagram",
    prompts: [],
    category: "instagram",
  },
];
