    ...
    <div className="w-full p-4 space-y-6">
      <div className="flex gap-2 items-center">
        <div className="relative size-14 rounded-full bg-sky-100 text-sky-800">
          <InspectIcon className="absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 size-7" />
        </div>
        <div className="space-y-1">
          <span className="text-lg font-medium text-sky-800">Langkah 1</span>
          <h1 className="text-3xl font-semibold">Pilih Fitur AI</h1>
        </div>
      </div>
